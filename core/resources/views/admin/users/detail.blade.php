        ...
        <div class="row gy-4">
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="widget-two style--two box--shadow2 b-radius--5 bg--blue">
                    ...
                    <a href="{{ route('admin.order.index') }}?search={{ $user->username }}" class="widget-two__btn">@lang('View All')</a>
                </div>
            </div>
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="widget-two style--two box--shadow2 b-radius--5 bg--success">
                    ...
                    <a href="{{ route('admin.hiring.index') }}?search={{ $user->username }}" class="widget-two__btn">@lang('View All')</a>
                </div>
            </div>
            ...
            <div class="card-header">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3 px-5">
                        <div class="form-group  col-xl-3 col-md-6 col-3">
                        ...
                        <div class="form-group col-xl-3 col-md-6 col-3">
                            ...
                            <input type="checkbox" data-width="100%" data-height="20" data-onstyle="-success" data-offstyle="-danger"
